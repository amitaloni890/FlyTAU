...
('AA101', 'Economy', 'B737-01', 'JFK', 'LAX', '2025-12-01 08:00', '2025-12-01 16:00', 200.0, NULL, 'Completed'),
('AA101', 'Business', 'B737-01', 'JFK', 'LAX', '2025-12-01 08:00', '2025-12-01 16:00', NULL, 600.0, 'Completed'),
('DL202', 'Economy', 'A320-02', 'LAX', 'ORD', '2026-01-05 09:00', '2026-01-05 13:00', 320.0, NULL, 'Completed'),
('DL202', 'Business', 'A320-02', 'LAX', 'ORD', '2026-01-05 09:00','2026-01-05 13:00', NULL, 850.0, 'Completed'),
('UA303', 'Economy', 'A380-12', 'ORD', 'JFK', '2025-08-03 07:00', '2025-08-03 10:30', 100.0, NULL, 'Completed'),
('UA303', 'Business', 'A380-12', 'ORD', 'JFK', '2025-08-03 07:00', '2025-08-03 10:30', NULL, 280.0, 'Completed'),
('SW404', 'Economy', 'D500-12', 'ATL', 'MIA', '2025-12-04 12:00', '2025-12-04 14:00', 200.0, NULL, 'Completed'),
('AA505', 'Economy', 'B787-09', 'MIA', 'JFK', '2025-12-05 10:00',  '2025-12-05 13:00', 310.0, NULL, 'Completed'),
('AA505', 'Business', 'B787-09', 'MIA', 'JFK', '2025-12-05 10:00', '2025-12-05 13:00', NULL, 820.0, 'Completed'),
('LY606', 'Economy', 'B787-09', 'JFK', 'TLV', '2026-05-10 10:00', '2026-05-10 21:00', 900.0, NULL, 'Active'),
('LY606', 'Business', 'B787-09', 'JFK', 'TLV', '2026-05-10 10:00', '2026-05-10 21:00', NULL, 1200.0, 'Fully Booked'),
('DX707', 'Economy', 'D900-08', 'TLV', 'DXB', '2026-04-12 08:00', '2026-04-12 11:30', 350.0, NULL, 'Active'),
('LY808', 'Economy', 'B747-11', 'JFK', 'TLV', '2025-11-20 22:00', '2025-11-21 09:00', 950.0, NULL, 'Completed'),
('LY808', 'Business', 'B747-11', 'JFK', 'TLV', '2025-11-20 22:00','2025-11-21 09:00', NULL, 3000.0, 'Completed'),
('BA909', 'Economy', 'B737-06', 'TLV', 'LHR', '2026-06-01 06:00', '2026-06-01 11:30', 450.0, NULL, 'Active'),
('LY110', 'Economy', 'B747-11', 'TLV', 'BKK', '2026-03-01 20:00', '2026-03-02 07:00', 1100.0, NULL, 'Active'),
('LY110', 'Business', 'B747-11', 'TLV', 'BKK', '2026-03-01 20:00', '2026-03-02 07:00', NULL, 4500.0, 'Active'),
('LY111', 'Economy', 'E175-13', 'TLV', 'FCO', '2025-10-15 09:00', '2025-10-15 13:00', 330.0, NULL, 'Completed'),
('AA112', 'Economy', 'B777-14', 'JFK', 'LAX', '2026-03-20 12:00', '2026-03-20 20:00', 400.0, NULL, 'Fully Booked'),
('AA112', 'Business', 'B777-14', 'JFK', 'LAX', '2026-03-20 12:00','2026-03-20 20:00', NULL, 1200.0, 'Active'),
('AF113', 'Economy', 'A320-02', 'ORD', 'TLV', '2026-03-15 14:00', '2026-03-16 00:00', 500.0, NULL, 'Active'),
('AF113', 'Business', 'A320-02', 'ORD', 'TLV', '2026-03-15 14:00', '2026-03-16 00:00', NULL, 1500.0, 'Active'),
('LY114', 'Economy', 'B737-01', 'LAX', 'DXB', '2025-12-25 10:00', '2025-12-26 01:00', 300.0, NULL, 'Canceled'),
('LY114', 'Business', 'B737-01', 'LAX', 'DXB', '2025-12-25 10:00', '2025-12-26 01:00', NULL, 500, 'Canceled'),
('LY115', 'Economy', 'D333-12', 'TLV', 'JFK', '2026-04-01 10:00', '2026-04-01 21:30', 880.0, NULL, 'Active'),
('LY115', 'Business', 'D333-12', 'TLV', 'JFK', '2026-04-01 10:00', '2026-04-01 21:30', NULL, 2900.0, 'Active');
